...
export NATS_JS_API_TIMEOUT="${NATS_JS_API_TIMEOUT:-30}"       # seconds for JetStream API/ack waits
export NATS_JS_ASYNC_MAX_PENDING="${NATS_JS_ASYNC_MAX_PENDING:-4000}"  # max in-flight publish acks
export NATS_JS_STALL_TIMEOUT="${NATS_JS_STALL_TIMEOUT:-30}"   # seconds to wait when async publish queue stalls
export NATS_JS_ACK_TIMEOUT="${NATS_JS_ACK_TIMEOUT:-30}"       # seconds to wait for async publish ack drain
